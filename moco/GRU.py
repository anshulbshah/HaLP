...
class BIGRU(nn.Module):
    def __init__(self, en_input_size, en_hidden_size, en_num_layers=3, num_class=60, return_premlp=False):
        ...
        self.return_premlp = return_premlp
    ...
    def forward(self, input_tensor, knn_eval=False):
        ...
        if knn_eval: # return last layer features during  KNN evaluation (action retrieval)
             ...
             if self.return_premlp:
              return out, encoder_hidden[0]
             return out