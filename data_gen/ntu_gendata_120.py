...
def gendata(data_path, out_path, ignored_sample_path=None, benchmark='xview', part='eval'):
    ...
    sample_label = []
    sample_folder = []
    for folder in [data_path[0], data_path[1]]:
        for filename in os.listdir(folder):
            ...
            if issample:
                ...
                sample_folder.append(folder)

    print(benchmark,len(sample_name))
    ...
    for i, s in enumerate(tqdm(sample_name)):
        data = read_xyz(os.path.join(sample_folder[i], s), max_body=max_body_kinect, num_joint=num_joint)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path2', default='../data/nturgbd_raw/nturgb+d_skeletons/')

    parser.add_argument('--ignored_sample_path',
                       default='../data/nturgbd_raw/NTU_RGBD120_samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='../data/NTU-RGB-D-120-AGCN-fixed2/')
